...
print(interface)
for i in range(0, 18):
    print(mydict['imdata'][i]['l1PhysIf']['attributes']['dn'], " " * 8, mydict['imdata'][i]['l1PhysIf']['attributes']['descr'], " " * 19, mydict['imdata'][i]['l1PhysIf']['attributes']['speed'], mydict['imdata'][i]['l1PhysIf']['attributes']['descr'], mydict['imdata'][i]['l1PhysIf']['attributes']['mtu'])
